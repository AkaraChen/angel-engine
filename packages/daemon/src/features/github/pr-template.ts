...
import { normalizeText } from "./gh-cli";
 ...
 */
export function discoverPullRequestTemplates(
  input: GitHubPullRequestTemplateInput,
...
function readTemplateFile(
  absolute: string,
  relative: string,
): GitHubPullRequestTemplate | null {
...
function dedupeByPath(
  ...
  const result: GitHubPullRequestTemplate[] = [];
...
function emptyTemplateResult(): GitHubPullRequestTemplateResult {
