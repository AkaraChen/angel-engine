...
CREATE INDEX IF NOT EXISTS `automations_enabled_next_run_idx` ON `automations` (`enabled`,`next_run_at`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `automation_runs_automation_started_idx` ON `automation_runs` (`automation_id`,`started_at`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `automation_runs_chat_id_idx` ON `automation_runs` (`chat_id`);
