...
function Command({
  ...
  return (
    <CommandPrimitive
      ...
      className={cn(
        `
          flex size-full flex-col overflow-hidden rounded-lg bg-popover p-1
...
function CommandDialog({
  ...
  const dialogTitle = title ?? t("ui.commandPalette");
  const dialogDescription = description ?? t("ui.commandDescription");
