...
export const de = {
  translation: {
    ...
    dialog: {
      ...
      importSession: {
        alreadyImported: "Importiert",
        clearSelection: "Leeren",
        cwdLabel: "Verzeichnis: {{cwd}}",
        description:
          "Quellagent und Zielprojekt wählen, Sitzungen markieren und in Angel Engine importieren.",
        done: "Fertig",
        empty:
          "Keine importierbaren Sitzungen für diesen Agenten und dieses Verzeichnis.",
        emptyFilter: "Keine Sitzungen passen zur Suche.",
        importAction: "{{count}} importieren",
        importFailed: "Sitzung konnte nicht importiert werden",
        importMore: "Weitere importieren",
        importing: "Wird importiert…",
        importingProgress: "Importiere {{done}} / {{total}}…",
        projectPlaceholder: "Projekt auswählen",
        projectRequired: "Vor dem Import ein Zielprojekt auswählen.",
        ...
        searchPlaceholder: "Nach Titel, Zeit oder Pfad suchen…",
        searching: "Sitzungen werden gesucht…",
        selectAll: "Alle auswählen",
        selectedCount: "{{count}} ausgewählt",
        selectionRequired: "Mindestens eine Sitzung zum Import auswählen.",
        sessionList: "Importierbare Sitzungen",
        sourceAgent: "Quellagent",
        status: {
          failed: "Fehlgeschlagen",
        ...
        summary: "{{succeeded}} importiert, {{failed}} fehlgeschlagen",
        targetProject: "Zielprojekt",
        title: "Sitzungen importieren",
        willCreateCopy:
          "Bereits importiert — erneuter Import erstellt eine Kopie.",
      },
