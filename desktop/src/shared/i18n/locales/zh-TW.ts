...
import { changeRequestZhTW } from "./change-request";
  ...
  translation: {
    ...
    workspace: {
      ...
      tools: {
        ...
        createPullRequest: {
          ...
          create: "建立變更要求",
          created: "已建立變更要求 #{{number}}",
          creating: "正在建立變更要求…",
          description: "發佈前請確認分支與描述。",
          existing: "變更要求 #{{number}} 已存在",
          noCommits: "基礎分支與目前分支之間沒有提交。",
          openInBrowser: "在瀏覽器中開啟",
          pushedRetry: "分支已推送。請重試建立變更要求。",
          pushing: "正在推送分支…",
          preview: {
            additions: "新增",
            body: "描述",
            ...
            copyLink: "複製連結",
            deletions: "刪除",
            description: "在瀏覽器中開啟前預覽變更要求。",
            emptyBody: "未提供描述。",
            filesChanged: "變更檔案",
            loadFailed: "無法載入變更要求詳細資料。",
            open: "開啟",
            title: "變更要求 #{{number}}",
          },
          retry: "重試",
          short: "建立變更要求",
          title: "建立變更要求",
          titlePlaceholder: "變更要求標題",
          view: "檢視變更要求 #{{number}}",
          viewShort: "變更要求 #{{number}}",
        ...
        empty: {
          ...
          noChanges: "沒有變更",
          noChecks: "此變更要求沒有回報檢查",
          noDiffForFile: "此檔案沒有差異",
          noProcesses: "沒有執行中的 Agent 子處理程序",
          noPullRequest: "目前分支沒有變更要求",
          noPullRequestDetail:
            "在目前分支開啟或綁定變更要求後即可載入 CI 檢查。",
    ...
    settings: {
      ...
      keyboard: {
        ...
        jumpToConflict: "跳至衝突命令",
        modifyShortcut: "修改快捷鍵",
        modifyShortcutLabel: "修改「{{command}}」快捷鍵，目前為 {{shortcut}}",
        openConfig: "開啟設定檔",
        recordingChordThen: "然後…",
        recordingHint: "按下新的快捷鍵 · Esc 取消",
        recordingCandidate: "候選鍵位",
        recordingCandidateAnnouncement: "候選鍵位 {{shortcut}}",
        recordingConflictAnnouncement:
          "候選鍵位 {{shortcut}} 與 {{command}} 衝突",
        remove: "移除",
        resetAll: "全部恢復預設…",
        ...
        resetCommand: "恢復此命令",
        resultSummary: "{{count}} 個命令 · {{modified}} 個已修改",
        saveAnyway: "仍然儲存",
        saveShortcut: "儲存快捷鍵",
    ...
    composer: {
      ...
      attachFiles: "附加檔案",
      attachChangeRequest: "附加變更要求或工作項目",
      attachChangeRequestConfirm: "附加",
      attachChangeRequestEmpty: "找不到工作項目或變更要求。",
      attachChangeRequestLoading: "取得中…",
      attachChangeRequestPlaceholder: "搜尋工作項目和變更要求…",
      attachChangeRequestTitle: "從原始碼控制附加",
      attachChangeRequestUpdated: "更新於 {{time}}",
      attachmentErrors: {
        accept: "沒有檔案符合允許的類型。",
        fileRead: "無法讀取所選檔案。",
      ...
      fromLink: "從連結",
      fromLinkPlaceholder:
        "貼上原始碼控制或 Linear 工作項目連結，或搜尋原始碼控制",
      sourceControlUnavailable: "此專案未啟用原始碼控制提供者。",
      sourceControlErrors: {
        cliMissing: "未安裝原始碼控制 CLI 或不在 PATH 中。請安裝後重試。",
        cliUnauthenticated: "原始碼控制提供者尚未驗證。請登入後重試。",
        fetchFailed: "無法取得該原始碼控制項目。",
        notFound: "找不到該工作項目或變更要求。",
        urlUnsupported: "不支援該原始碼控制連結。",
      },
      workItem: "工作項目",
      changeRequest: "變更要求",
    ...
    components: {
      ...
      toolGroup: {
        ...
        calledTools_one: "呼叫了 {{count}} 個工具",
        calledTools_other: "呼叫了 {{count}} 個工具",
        thinking: "思考中…",
        thoughtAndToolCalls_one: "思考並呼叫了 {{count}} 個工具",
        thoughtAndToolCalls_other: "思考並呼叫了 {{count}} 個工具",
        thoughtSeconds_one: "已思考 {{count}}s",
        thoughtSeconds_other: "已思考 {{count}}s",
    ...
    dialog: {
      ...
      importSession: {
        ...
        empty: "沒有可匯入的對話",
        emptyDetail: "Angel Engine 只能讀到本機已安裝的智慧體裡的對話。",
        importAction: "匯入 {{selected}} 筆到 {{projectName}}",
        importFailed: "無法匯入對話",
        importing: "正在匯入…",
        noMatches: "沒有符合的對話",
        searchPlaceholder: "搜尋要匯入的對話…",
        noMatchesDetail: "換個關鍵字，或者切換上面的智慧體篩選。",
    ...
    projectImport: {
      ...
      clone: "複製",
      cloneTo: "正在複製到 {{path}}",
      description: "從原始碼控制選擇儲存庫，或貼上 git 網址。",
      ...
      noOwners: "沒有可用的原始碼控制帳戶",
      noRepositories: "沒有儲存庫",
      openProject: "開啟專案",
      owners: "帳戶",
      ownersFailed: "無法載入原始碼控制帳戶",
      readyTitle: "儲存庫已就緒",
      privateBadge: "私人",
    ...
    ui: {
      ...
      commandShepherdChangeRequest: "Shepherd 變更要求",
    },
    promptInput: {
