  ...
  translation: {
    ...
    dialog: {
      ...
      importSession: {
        ...
        cwdLabel: "目錄：{{cwd}}",
        description:
          "選擇來源代理與目標專案，勾選要匯入的工作階段，批次匯入到 Angel Engine。",
        done: "完成",
        empty: "此代理和目錄下沒有可匯入的工作階段。",
        emptyFilter: "沒有符合搜尋條件的工作階段。",
        importAction: "匯入 {{count}} 筆",
        importFailed: "無法匯入工作階段",
        importMore: "繼續匯入",
        importing: "正在匯入…",
        importingProgress: "正在匯入 {{done}} / {{total}}…",
        projectPlaceholder: "請選擇專案",
        projectRequired: "匯入前請先選擇目標專案。",
        retryFailed: "重試失敗項（{{count}}）",
        runtimeLabel: "代理：{{runtime}}",
        runtimeRequired: "匯入工作階段前請先選擇代理。",
        searchFailed: "無法搜尋工作階段",
        searchPlaceholder: "依標題、時間或路徑搜尋…",
        searching: "正在搜尋工作階段…",
        selectAll: "全選",
        selectedCount: "已選 {{count}} 筆",
        selectionRequired: "請至少選擇一筆工作階段再匯入。",
        sessionList: "可匯入的工作階段",
        sourceAgent: "來源代理",
        status: {
          failed: "失敗",
          importing: "匯入中…",
        ...
        summary: "成功 {{succeeded}} 筆，失敗 {{failed}} 筆",
        targetProject: "目標專案",
        title: "匯入工作階段",
        willCreateCopy: "先前已匯入 — 再次匯入會建立副本。",
      },
      renameChat: "重新命名聊天",
      sessionHandoff: {
