  ...
  translation: {
    ...
    dialog: {
      ...
      importSession: {
        ...
        cwdLabel: "目录：{{cwd}}",
        description:
          "选择来源智能体与目标项目，勾选要导入的会话，批量导入到 Angel Engine。",
        done: "完成",
        empty: "此智能体和目录下没有可导入的会话。",
        emptyFilter: "没有匹配搜索条件的会话。",
        importAction: "导入 {{count}} 条",
        importFailed: "无法导入会话",
        importMore: "继续导入",
        importing: "正在导入…",
        importingProgress: "正在导入 {{done}} / {{total}}…",
        projectPlaceholder: "请选择项目",
        projectRequired: "导入前请先选择目标项目。",
        retryFailed: "重试失败项（{{count}}）",
        runtimeLabel: "智能体：{{runtime}}",
        runtimeRequired: "导入会话前请先选择智能体。",
        searchFailed: "无法搜索会话",
        searchPlaceholder: "按标题、时间或路径搜索…",
        searching: "正在搜索会话…",
        selectAll: "全选",
        selectedCount: "已选 {{count}} 条",
        selectionRequired: "请至少选择一条会话再导入。",
        sessionList: "可导入的会话",
        sourceAgent: "来源智能体",
        status: {
          failed: "失败",
        ...
        summary: "成功 {{succeeded}} 条，失败 {{failed}} 条",
        targetProject: "目标项目",
        title: "导入会话",
        willCreateCopy: "此前已导入 — 再次导入会创建副本。",
      },
      renameChat: "重命名聊天",
      sessionHandoff: {
