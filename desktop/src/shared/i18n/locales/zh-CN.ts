...
export const zhCN = {
  translation: {
    ...
    pullRequests: {
      ...
      create: "创建 PR",
      createAsDraft: "创建为草稿",
      createSubmit: "创建 Pull Request",
      createTitle: "创建 Pull Request",
      description: "描述",
      empty: "没有匹配的 Pull Request。",
      emptyBody: "（空）",
      fieldBase: "目标分支",
      fieldBasePlaceholder: "留空则使用仓库默认分支",
      fieldBody: "正文",
      fieldTitle: "标题",
      filterState: "按状态筛选",
      noComments: "暂无评论。",
      ...
      openWorkspace: "打开工作区",
      postComment: "发表评论",
      search: "搜索 Pull Request…",
      selectPrompt: "选择一个 Pull Request 查看详情。",
      states: {
        all: "全部",
        closed: "已关闭",
        merged: "已合并",
