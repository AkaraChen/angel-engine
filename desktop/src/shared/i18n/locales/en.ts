...
import { scheduleEn } from "./schedule";
import { changeRequestEn } from "./change-request";
  ...
  translation: {
    ...
    workspace: {
      ...
      tools: {
        ...
        checks: {
          ...
          openPullRequest: "Open change request",
        ...
        createPullRequest: {
          ...
          created: "Change request #{{number}} created",
          creating: "Creating change request…",
          description: "Review the branches and description before publishing.",
          existing: "Change request #{{number}} already exists",
          noCommits: "No commits between the base and head branches.",
          openInBrowser: "Open in browser",
          pushedRetry: "Branch pushed. Retry creating the change request.",
          ...
          preview: {
            ...
            deletions: "Deletions",
            description:
              "Review the change request before opening it in your browser.",
            emptyBody: "No description provided.",
            filesChanged: "Files changed",
            loadFailed: "Could not load change request details.",
            open: "Open",
            title: "Change request #{{number}}",
          },
          retry: "Retry",
          short: "Create change request",
          title: "Create change request",
          titlePlaceholder: "Change request title",
          view: "View change request #{{number}}",
          viewShort: "change request #{{number}}",
        ...
        empty: {
          ...
          noChecks: "No checks reported for this change request",
          noDiffForFile: "No diff for file",
          noProcesses: "No agent subprocesses running",
          noPullRequest: "No change request for this branch",
          noPullRequestDetail:
            "Open or bind a change request on the current branch to load CI checks.",
    ...
    settings: {
      ...
      keyboard: {
        ...
        jumpToConflict: "Jump to conflicting command",
        modifyShortcut: "Modify shortcut",
        modifyShortcutLabel:
          "Modify {{command}} shortcut, currently {{shortcut}}",
        openConfig: "Open config file",
        recordingChordThen: "then…",
        recordingHint: "Press a new shortcut · Esc to cancel",
        recordingCandidate: "Candidate shortcut",
        recordingCandidateAnnouncement: "Candidate shortcut {{shortcut}}",
        recordingConflictAnnouncement:
          "Candidate shortcut {{shortcut}} conflicts with {{command}}",
        remove: "Remove",
        ...
        resultSummary: "{{count}} commands · {{modified}} modified",
    ...
    composer: {
      ...
      attachChangeRequest: "Attach change request or work item",
      attachChangeRequestConfirm: "Attach",
      attachChangeRequestEmpty: "No work items or change requests found.",
      attachChangeRequestLoading: "Fetching…",
      attachChangeRequestPlaceholder: "Search work items and change requests…",
      attachChangeRequestTitle: "Attach from source control",
      attachChangeRequestUpdated: "updated {{time}}",
      attachmentErrors: {
      ...
      fromLink: "From link",
      fromLinkPlaceholder:
        "Paste a source control or Linear work item link, or search source control",
      sourceControlUnavailable:
        "No source control provider is active for this project.",
      sourceControlErrors: {
        cliMissing:
          "The source control CLI is not installed or not on PATH. Install it and try again.",
        cliUnauthenticated:
          "The source control provider is not authenticated. Sign in and try again.",
        fetchFailed: "Could not fetch that source control item.",
        notFound: "The work item or change request was not found.",
        urlUnsupported: "That source control URL is not supported.",
      },
      workItem: "Work item",
      ...
      taskLinkErrors: {
        ...
        prForkUnsupported: "Change requests from forks are not supported yet.",
        unsupported: "That task link is not supported.",
      },
      taskLinkHintComplete:
        "Paste a complete source control work item, change request, or Linear work item link.",
      taskLinkHintSourceControlPath:
        "This is a source control link, but it is not a work item or change request.",
      taskLinkHintLinearPath: "This is a Linear link, but it is not an issue.",
      taskLinkHintSupported:
        "Supported links: source control work items, change requests, and Linear work items.",
    ...
    components: {
      ...
      toolGroup: {
        ...
        calledTools_one: "Called {{count}} tool",
        calledTools_other: "Called {{count}} tools",
        thinking: "Thinking…",
        thoughtAndToolCalls_one: "Thought and called {{count}} tool",
        thoughtAndToolCalls_other: "Thought and called {{count}} tools",
        thoughtSeconds_one: "Thought for {{count}}s",
        thoughtSeconds_other: "Thought for {{count}}s",
    ...
    projectImport: {
      ...
      description: "Pick a repository from source control, or paste a git URL.",
      ...
      noOwners: "No source control accounts available",
      noRepositories: "No repositories",
      openProject: "Open project",
      owners: "Accounts",
      ownersFailed: "Could not load source control accounts",
      ...
      tabSourceControl: "source control",
      tabUrl: "Git URL",
    ...
    ui: {
      ...
      commandShepherdChangeRequest: "Shepherd change request",
    },
    promptInput: {
