  ...
  translation: {
    ...
    dialog: {
      ...
      importSession: {
        ...
        cwdLabel: "디렉터리: {{cwd}}",
        description:
          "소스 에이전트와 대상 프로젝트를 고르고 세션을 선택한 뒤 Angel Engine으로 가져옵니다.",
        done: "완료",
        empty: "이 에이전트와 디렉터리에 가져올 세션이 없습니다.",
        emptyFilter: "검색과 일치하는 세션이 없습니다.",
        importAction: "{{count}}개 가져오기",
        importFailed: "세션을 가져올 수 없습니다",
        importMore: "더 가져오기",
        importing: "가져오는 중…",
        importingProgress: "가져오는 중 {{done}} / {{total}}…",
        projectPlaceholder: "프로젝트 선택",
        projectRequired: "가져오기 전에 대상 프로젝트를 선택하세요.",
        retryFailed: "실패 항목 재시도 ({{count}})",
        runtimeLabel: "에이전트: {{runtime}}",
        runtimeRequired: "세션을 가져오기 전에 에이전트를 선택하세요.",
        searchFailed: "세션을 검색할 수 없습니다",
        searchPlaceholder: "제목, 시간 또는 경로로 검색…",
        searching: "세션 검색 중…",
        selectAll: "모두 선택",
        selectedCount: "{{count}}개 선택됨",
        selectionRequired: "가져올 세션을 하나 이상 선택하세요.",
        sessionList: "가져올 수 있는 세션",
        sourceAgent: "소스 에이전트",
        status: {
          failed: "실패",
          importing: "가져오는 중…",
        ...
        summary: "성공 {{succeeded}}개, 실패 {{failed}}개",
        targetProject: "대상 프로젝트",
        title: "세션 가져오기",
        willCreateCopy: "이미 가져옴 — 다시 가져오면 복사본이 만들어집니다.",
      },
      renameChat: "채팅 이름 변경",
      sessionHandoff: {
