  ...
  translation: {
    ...
    settings: {
      ...
      keyboard: {
        ...
        conflictWith: "‘{{command}}’과 충돌",
        emptySearch: "이 검색과 일치하는 명령이 없습니다.",
        filterAll: "전체",
        filterConflicts: "충돌",
        filterModified: "수정됨",
        filterUnbound: "할당되지 않음",
        hintsLink: "단축키 힌트 표시 설정은 모양에 있습니다.",
        loadFailedDescription:
          "파일을 수정하거나 재설정할 때까지 기본 키 바인딩을 사용합니다.",
        loadFailedTitle: "keybindings.json을 불러올 수 없습니다",
        jumpToConflict: "충돌 명령으로 이동",
        modifyShortcut: "단축키 수정",
        modifyShortcutLabel: "{{command}} 단축키 수정, 현재 {{shortcut}}",
        openConfig: "설정 파일 열기",
        recordingChordThen: "그다음…",
        recordingHint: "새 단축키를 누르세요 · Esc로 취소",
        recordingCandidate: "후보 단축키",
        recordingCandidateAnnouncement: "후보 단축키 {{shortcut}}",
        recordingConflictAnnouncement:
          "단축키 {{shortcut}}이(가) {{command}}과 충돌합니다",
        remove: "제거",
        ...
        resetCommand: "명령 재설정",
        resultSummary: "명령 {{count}}개 · 수정 {{modified}}개",
        saveAnyway: "그래도 저장",
        saveShortcut: "단축키 저장",
    ...
    components: {
      ...
      toolGroup: {
        ...
        calledTools_one: "도구 {{count}}개 호출",
        calledTools_other: "도구 {{count}}개 호출",
        thinking: "생각 중…",
        thoughtAndToolCalls_one: "생각하고 도구 {{count}}개 호출",
        thoughtAndToolCalls_other: "생각하고 도구 {{count}}개 호출",
        thoughtSeconds_one: "{{count}}초 동안 생각함",
        thoughtSeconds_other: "{{count}}초 동안 생각함",
