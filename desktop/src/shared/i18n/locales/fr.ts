...
export const fr = {
  translation: {
    ...
    dialog: {
      ...
      importSession: {
        alreadyImported: "Importée",
        clearSelection: "Effacer",
        cwdLabel: "Répertoire : {{cwd}}",
        description:
          "Choisissez un agent source et un projet cible, sélectionnez des sessions, puis importez-les dans Angel Engine.",
        done: "Terminé",
        empty: "Aucune session importable pour cet agent et ce répertoire.",
        emptyFilter: "Aucune session ne correspond à cette recherche.",
        importAction: "Importer {{count}}",
        importFailed: "Impossible d’importer la session",
        importMore: "Importer encore",
        importing: "Importation…",
        importingProgress: "Importation {{done}} / {{total}}…",
        projectPlaceholder: "Sélectionner un projet",
        projectRequired: "Sélectionnez un projet cible avant d’importer.",
        ...
        searchPlaceholder: "Rechercher par titre, date ou chemin…",
        searching: "Recherche des sessions…",
        selectAll: "Tout sélectionner",
        selectedCount: "{{count}} sélectionnée(s)",
        selectionRequired: "Sélectionnez au moins une session à importer.",
        sessionList: "Sessions importables",
        ...
        summary: "{{succeeded}} importée(s), {{failed}} en échec",
        targetProject: "Projet cible",
        title: "Importer des sessions",
        willCreateCopy:
          "Déjà importée — une nouvelle importation crée une copie.",
      },
