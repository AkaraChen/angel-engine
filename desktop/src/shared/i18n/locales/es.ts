...
export const es = {
  translation: {
    ...
    dialog: {
      ...
      importSession: {
        alreadyImported: "Importada",
        clearSelection: "Borrar",
        cwdLabel: "Directorio: {{cwd}}",
        description:
          "Elige un agente de origen y un proyecto de destino, selecciona sesiones e impórtalas a Angel Engine.",
        done: "Listo",
        empty: "No hay sesiones importables para este agente y directorio.",
        emptyFilter: "Ninguna sesión coincide con la búsqueda.",
        importAction: "Importar {{count}}",
        importFailed: "No se pudo importar la sesión",
        importMore: "Importar más",
        importing: "Importando…",
        importingProgress: "Importando {{done}} / {{total}}…",
        projectPlaceholder: "Selecciona un proyecto",
        projectRequired: "Selecciona un proyecto de destino antes de importar.",
        ...
        searchPlaceholder: "Buscar por título, hora o ruta…",
        searching: "Buscando sesiones…",
        selectAll: "Seleccionar todo",
        selectedCount: "{{count}} seleccionadas",
        selectionRequired: "Selecciona al menos una sesión para importar.",
        sessionList: "Sesiones importables",
        sourceAgent: "Agente de origen",
        status: {
          failed: "Error",
          importing: "Importando…",
          pending: "Pendiente",
        ...
        summary: "Importadas {{succeeded}}, fallidas {{failed}}",
        targetProject: "Proyecto de destino",
        title: "Importar sesiones",
        willCreateCopy: "Ya importada — importar de nuevo crea una copia.",
      },
