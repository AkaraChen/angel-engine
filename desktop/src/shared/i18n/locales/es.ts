...
export const es = {
  translation: {
    ...
    commands: {
      ...
      chatFocusComposer: "Enfocar el compositor del chat",
      chatInterrupt: "Interrumpir ejecución",
      chatNew: "Nuevo chat",
      chatNewline: "Insertar salto de línea",
      chatRemoveLastAttachment: "Quitar el último archivo adjunto",
      ...
      workspaceNextTab: "Pestaña siguiente",
      workspacePreviousTab: "Pestaña anterior",
      workspaceToggleSidebar: "Mostrar u ocultar la barra lateral",
    },
    common: {
      allow: "Permitir",
    ...
    settings: {
      ...
      keyboard: {
        ...
        bindEscape: "Asignar Escape",
        clearSearch: "Borrar búsqueda",
        conflictAmbiguous: "Conflicto ambiguo — prevalece el último registro",
        conflictChordPrefix: "Conflicto de prefijo de acorde",
        conflictShadowed: "Oculto por un atajo de mayor prioridad",
        conflictWith: "En conflicto con «{{command}}»",
        emptySearch: "Ningún comando coincide con esta búsqueda.",
        filterAll: "Todos",
        filterConflicts: "Conflictos",
        filterModified: "Modificados",
        filterUnbound: "Sin asignar",
        hintsLink: "La visibilidad de las pistas de atajos está en Apariencia.",
        loadFailedDescription:
          "Se usan los atajos predeterminados hasta que se corrija o restablezca el archivo.",
        loadFailedTitle: "No se pudo cargar keybindings.json",
        jumpToConflict: "Ir al comando en conflicto",
        modifyShortcut: "Modificar atajo",
        modifyShortcutLabel:
          "Modificar el atajo de {{command}}, actualmente {{shortcut}}",
        openConfig: "Abrir archivo de configuración",
        recordingChordThen: "luego…",
        recordingHint: "Pulsa un atajo nuevo · Esc para cancelar",
        recordingCandidate: "Atajo candidato",
        recordingCandidateAnnouncement: "Atajo candidato {{shortcut}}",
        recordingConflictAnnouncement:
          "El atajo {{shortcut}} entra en conflicto con {{command}}",
        remove: "Quitar",
        resetAll: "Restablecer todo a los valores predeterminados…",
        resetAllConfirm:
          "¿Restablecer todos los atajos personalizados? Se conservará una copia de seguridad local.",
        resetBroken: "Restablecer configuración dañada",
        resetCategory: "Restablecer valores predeterminados de la categoría",
        resetCommand: "Restablecer comando",
        resultSummary: "{{count}} comandos · {{modified}} modificados",
        saveAnyway: "Guardar de todos modos",
        saveShortcut: "Guardar atajo",
        searchPlaceholder: "Buscar comandos o teclas…",
        sourceConflict: "Conflicto",
        sourceDefault: "Predeterminado",
        sourceUser: "Usuario",
        sourceUserOverride: "Usuario · anulado",
        unbound: "Sin asignar",
        warningsCount: "{{count}} advertencia(s) al cargar los atajos",
      },
      linear: {
      ...
      tabDescriptions: {
        keyboard: "Cambiar atajos de teclado y resolver conflictos.",
        agents:
      ...
      updates: {
        ...
        stateError: "La actualización falló: {{detail}}",
        stateIdleDetail: "Última comprobación: {{time}}.",
        stateInstalling: "Comprobando la versión {{version}}…",
        stateUnchecked: "Aún no se han buscado actualizaciones.",
        stateUpToDate: "Tienes la última versión de este canal.",
        unsupported:
    ...
    components: {
      ...
      toolGroup: {
        ...
        calledTools_one: "Llamó a {{count}} herramienta",
        calledTools_other: "Llamó a {{count}} herramientas",
        thinking: "Pensando…",
        thoughtAndToolCalls_one: "Pensó y llamó a {{count}} herramienta",
        thoughtAndToolCalls_other: "Pensó y llamó a {{count}} herramientas",
        thoughtSeconds_one: "Pensó durante {{count}} s",
        thoughtSeconds_other: "Pensó durante {{count}} s",
