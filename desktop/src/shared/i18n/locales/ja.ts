...
import { changeRequestJa } from "./change-request";
  ...
  translation: {
    ...
    workspace: {
      ...
      tools: {
        ...
        createPullRequest: {
          ...
          create: "変更リクエストを作成",
          created: "変更リクエスト #{{number}} を作成しました",
          creating: "変更リクエストを作成中…",
          description: "公開前にブランチと説明を確認してください。",
          existing: "変更リクエスト #{{number}} は既に存在します",
          noCommits:
          ...
          preview: {
            ...
            copyLink: "リンクをコピー",
            deletions: "削除",
            description: "ブラウザで開く前に変更リクエストを確認します。",
            emptyBody: "説明はありません。",
            filesChanged: "変更ファイル",
            loadFailed: "変更リクエストの詳細を読み込めませんでした。",
            open: "オープン",
            title: "変更リクエスト #{{number}}",
          },
          retry: "再試行",
          short: "変更リクエスト を作成",
          title: "変更リクエストを作成",
          titlePlaceholder: "変更リクエストのタイトル",
          view: "変更リクエスト #{{number}} を表示",
          viewShort: "変更リクエスト #{{number}}",
        ...
        empty: {
          ...
          noChanges: "変更はありません",
          noChecks: "この変更リクエストに報告されたチェックはありません",
          noDiffForFile: "このファイルに差分はありません",
          noProcesses: "実行中のエージェントサブプロセスはありません",
          noPullRequest: "このブランチには変更リクエストがありません",
          noPullRequestDetail:
            "現在のブランチで 変更リクエスト を開くか紐付けると CI チェックを読み込みます。",
    ...
    settings: {
      ...
      keyboard: {
        ...
        jumpToConflict: "競合するコマンドへ移動",
        modifyShortcut: "ショートカットを変更",
        modifyShortcutLabel:
          "{{command}} のショートカットを変更、現在は {{shortcut}}",
        openConfig: "設定ファイルを開く",
        recordingChordThen: "次に…",
        recordingHint: "新しいショートカットを押す · Esc でキャンセル",
        recordingCandidate: "候補のショートカット",
        recordingCandidateAnnouncement: "候補のショートカット {{shortcut}}",
        recordingConflictAnnouncement:
          "ショートカット {{shortcut}} は {{command}} と競合しています",
        remove: "削除",
        ...
        resultSummary: "{{count}} コマンド · {{modified}} 件変更済み",
        saveAnyway: "このまま保存",
    ...
    composer: {
      ...
      attachFiles: "ファイルを添付",
      attachChangeRequest: "変更リクエストまたは作業項目を添付",
      attachChangeRequestConfirm: "添付",
      attachChangeRequestEmpty:
        "作業項目または変更リクエストが見つかりません。",
      attachChangeRequestLoading: "取得中…",
      attachChangeRequestPlaceholder: "作業項目と変更リクエストを検索…",
      attachChangeRequestTitle: "ソース管理から添付",
      attachChangeRequestUpdated: "{{time}}に更新",
      attachmentErrors: {
      ...
      fromLink: "リンクから",
      fromLinkPlaceholder:
        "ソース管理または Linear の作業項目リンクを貼り付けるか、ソース管理を検索",
      sourceControlUnavailable:
        "このプロジェクトではソース管理プロバイダーが有効ではありません。",
      sourceControlErrors: {
        cliMissing:
          "ソース管理 CLI がインストールされていないか PATH にありません。",
        cliUnauthenticated: "ソース管理プロバイダーが認証されていません。",
        fetchFailed: "ソース管理の項目を取得できませんでした。",
        notFound: "作業項目または変更リクエストが見つかりません。",
        urlUnsupported: "このソース管理 URL はサポートされていません。",
      },
      workItem: "作業項目",
      ...
      taskLinkErrors: {
        ...
        prForkUnsupported:
          "fork からの変更リクエストはまだサポートされていません。",
        unsupported: "このタスクリンクはサポートされていません。",
      },
      taskLinkHintComplete:
        "ソース管理の作業項目、変更リクエスト、または Linear 作業項目の完全なリンクを貼り付けてください。",
      taskLinkHintSourceControlPath:
        "ソース管理のリンクですが、作業項目または変更リクエストではありません。",
      taskLinkHintLinearPath: "Linear のリンクですが、Issue ではありません。",
      taskLinkHintSupported:
        "ソース管理の作業項目、変更リクエスト、Linear 作業項目のリンクに対応しています。",
    ...
    projectImport: {
      ...
      description:
        "ソース管理 からリポジトリを選ぶか、git URL を貼り付けます。",
      ...
      noOwners: "利用できる ソース管理 アカウントがありません",
      noRepositories: "リポジトリがありません",
      openProject: "プロジェクトを開く",
      owners: "アカウント",
      ownersFailed: "ソース管理 アカウントを読み込めませんでした",
    ...
    ui: {
      ...
      commandShepherdChangeRequest: "Shepherd 変更リクエスト",
    },
    promptInput: {
