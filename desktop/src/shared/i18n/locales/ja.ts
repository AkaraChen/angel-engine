  ...
  translation: {
    ...
    dialog: {
      ...
      importSession: {
        ...
        cwdLabel: "ディレクトリ: {{cwd}}",
        description:
          "ソースエージェントと対象プロジェクトを選び、セッションを選択して Angel Engine にインポートします。",
        done: "完了",
        empty:
          "このエージェントとディレクトリにインポート可能なセッションはありません。",
        emptyFilter: "検索に一致するセッションはありません。",
        importAction: "{{count}} 件をインポート",
        importFailed: "セッションをインポートできませんでした",
        importMore: "続けてインポート",
        importing: "インポート中…",
        importingProgress: "インポート中 {{done}} / {{total}}…",
        projectPlaceholder: "プロジェクトを選択",
        projectRequired: "インポート前に対象プロジェクトを選択してください。",
        retryFailed: "失敗を再試行（{{count}}）",
        runtimeLabel: "エージェント: {{runtime}}",
        runtimeRequired:
          "セッションをインポートする前にエージェントを選択してください。",
        searchFailed: "セッションを検索できませんでした",
        searchPlaceholder: "タイトル、時間、パスで検索…",
        searching: "セッションを検索中…",
        selectAll: "すべて選択",
        selectedCount: "{{count}} 件選択中",
        selectionRequired:
          "インポートするセッションを 1 件以上選択してください。",
        sessionList: "インポート可能なセッション",
        sourceAgent: "ソースエージェント",
        status: {
          failed: "失敗",
          importing: "インポート中…",
          pending: "待機中",
        ...
        summary: "成功 {{succeeded}} 件、失敗 {{failed}} 件",
        targetProject: "対象プロジェクト",
        title: "セッションをインポート",
        willCreateCopy:
          "インポート済み — 再インポートするとコピーが作成されます。",
      },
      renameChat: "チャット名を変更",
      sessionHandoff: {
