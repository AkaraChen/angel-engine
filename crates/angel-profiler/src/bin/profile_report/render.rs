use angel_profiler::{ProfileReport, ProfileStep, ProfileStepStatus};

use super::ProfileRun;

pub(super) fn render_html(runs: &[ProfileRun]) -> String {
...
pub(super) fn print_summary(runs: &[ProfileRun]) {
    println!();
